...
// 단계 D-fixup-8 (결정 68~71): 일괄(holistic) 분석 4축 회귀 사실 정정 → 6축 항상 보장 정합.
  ...
  "episode_scores": [
    {
      ...
      "score": 0-100 정수,
      "dimensions": {
        "첫 훅·몰입": { "score": 0-100 정수, "comment": "이 회차의 본문을 근거로 한 한 문장" },
        "인물 매력": { "score": 0-100 정수, "comment": "이 회차의 본문을 근거로 한 한 문장" },
        "세계관": { "score": 0-100 정수, "comment": "이 회차의 본문을 근거로 한 한 문장" },
        "긴장감": { "score": 0-100 정수, "comment": "이 회차의 본문을 근거로 한 한 문장" },
        "로맨스·감정선": { "score": 0-100 정수, "comment": "이 회차의 본문을 근거로 한 한 문장" },
        "독창성": { "score": 0-100 정수, "comment": "이 회차의 본문을 근거로 한 한 문장" }
      },
...
- dimensions 키 이름은 위 **여섯 가지 한글 이름을 정확히** 사용하세요. 영어 키·스네이크케이스 금지.`;
