...
- **event**: 사건/행동/발생 (예: "강하늘이 던전 입구를 발견했다")
- **state_change**: 인물 상태 변화 (예: "강하늘이 S급 헌터로 각성했다")
- **relationship_change**: 관계 변화 (예: "강하늘과 이서연이 동료가 되었다")
- **foreshadow_planted**: 복선 심기 (예: "어머니가 남긴 검의 정체가 본문에 미공개")
- **foreshadow_resolved**: 복선 회수 (예: "어머니의 검이 고대 유물임이 밝혀졌다")
